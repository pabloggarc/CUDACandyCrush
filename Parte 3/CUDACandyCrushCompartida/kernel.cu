...
/*
   a y b: l�mites del intervalo del que se quiere obtener un n�mero aleatorio
...
/*
    ...
    fila y columna: del elemento tocado
    borrados: n�mero de casillas marcadas con X
...
void calcular_dimensiones_optimas(dim3* grid, dim3* bloques) {
    ...
    //Calcular bloques e hilos seg�n caracter�sticas del SM
